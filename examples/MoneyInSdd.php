 ...
 *      Steps :
 *          - MoneyInSddInit : debiting 15 EUR from SDD Mandate, and automatically sending 1 EUR to your wallet
 *          (merchant). Note :
...
// GetMoneyInSdd
$resGetMoney = $api->GetMoneyInSdd(['updateDate' => time() - 60 * 10]);
