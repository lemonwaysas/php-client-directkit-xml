 ...
 *          - MoneyOut : debiting the 8 EUR remaining on the customer's wallet, and automatically sending 1 EUR to your
 *          merchant wallet. 7 EUR will be sent to the customer's bank account Note :
 *          - You can register many IBANs on the same wallet
 *          - When you call for a MoneyOut, you can either specify the destination IBAN's ID in ibanId parameter, or
 *          leave it empty. If left empty, the latest registered IBAN will be used
 *          - The "message" parameter in MoneyOut can be displayed on the customer's bank statement. Please contact
...
$res5 = $api->GetMoneyOutTransDetails(['transactionId' => $res4->operation->ID]);
