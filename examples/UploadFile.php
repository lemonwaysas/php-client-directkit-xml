 ...
 *          - after the successful upload, the file will be pending review. You won't be able to upload a file of the
 *          same type for the same wallet until the first one is reviewed.
 */
